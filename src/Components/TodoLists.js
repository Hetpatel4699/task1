...
import { deleteTodo, editTodo, markTodoCompleted, clearAlltodo } from "../Assets/Screens/reduxTodo/actions";
                        ...
                        {todos && todos
                            ...
                            .map((todo, index) => (
                                <tr key={index}>
                                    ...
                                    <td>
                                        {todo?.isCompleted ? (
                                            <button className="btn btn-sm btn-success p-2">Completed</button>
                                        ) :
                                            <button className="btn btn-sm btn-danger p-2">Pending</button>
                                        }
                                    </td>
                                    <td>
                                        <button
